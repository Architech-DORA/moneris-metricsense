...
func RegisterRouter(r *gin.Engine) {
	...
	r.GET("/deployment-frequency", metrics.GetDeploymentFrequency)
	r.GET("/lead-time-for-changes", metrics.GetLeadTimeForChanges)
	r.GET("/median-time-to-restore", metrics.GetMedianTimeToRestore)
	r.GET("/change-failure-rate", metrics.GetChangeFailureRate)
