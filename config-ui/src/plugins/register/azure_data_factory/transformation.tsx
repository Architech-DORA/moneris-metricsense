...
import { HelpTooltip, ExternalLink, Divider } from '@/components';
...
export const KubeDeploymentTransformation = ({ connectionId, transformation, setTransformation }: Props) => {
  // const [requirements, setRequirements] = useState<string[]>([]);
  // const [bugs, setBugs] = useState<string[]>([]);
  // const [incidents, setIncidents] = useState<string[]>([]);

  // const prefix = useProxyPrefix({ plugin: 'kube_deployment', connectionId });
